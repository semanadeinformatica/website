...
<template>
  <main class="min-h-screen bg-2023-bg">
    <div class="flex flex-col gap-[60px] py-[65px] justify-evenly items-center content-center min-h-screen">
                <img id="svg-1" class="animate-2023-maintenance-jump opacity-50 absolute max-[900px]:hidden w-[150px] left-[7%]" src="storage/images/cy-sinf.svg" alt="Stylized SINF logo">
                <img id="svg-2" class="animate-2023-maintenance-jump opacity-50 absolute max-[900px]:hidden top-[70px] w-[120px] right-[7%]" src="storage/images/rc-sinf.svg" alt="Stylized SINF logo">
                <img id="svg-3" class="animate-2023-maintenance-jump opacity-50 absolute max-[900px]:hidden bottom-[100px] w-[90px] right-[15%]" src="storage/images/oc-sinf.svg" alt="Stylized SINF logo">
                ...
                <p class="text-2023-teal text-lg font-bold m-0 max-[900px]:text-base">Estamos a preparar mais uma edição da SINF!</p>
                <a href="https://sinf.pt" class="text-2023-teal no-underline text-lg font-bold m-0 max-[900px]:text-base relative">
